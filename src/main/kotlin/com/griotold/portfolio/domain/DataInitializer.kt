package com.griotold.portfolio.domain

import com.griotold.portfolio.domain.constant.SkillType
import com.griotold.portfolio.domain.entity.*
import com.griotold.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        println("스프링이 실행되었씁니다. 테스트 데이터를 초기화 합니다.")

        val achievements = mutableListOf<Achievement>(
            Achievement(
                title = "2022 Catkao 해커톤 최우수상",
                description = "고양이 쇼핑몰 검색 서비스의 아키텍처, 데이터 모델링, API 개발",
                host = "캣카오",
            ...
            Achievement(
                title = "정보처리기사",
                description = "자료구조, 운영체제, 안고리즘, 데이터베이스 등",
                host = "한국산업인력공단",
        ...
        val introductions = mutableListOf<Introduction>(
            ...
            Introduction(content = "기존 소스를 리팩토링하여 더 좋은 구조를 개선하는 작업을 좋아합니다.", isActive = true)
        )
        introductionRepository.saveAll(introductions)

        val links = mutableListOf<Link>(
            Link(name = "Github", content = "https://github.com/infomuscle", isActive = true),
            Link(name = "Linkedin", content = "https://linkedin.com/in/bokeunjeong", isActive = true)
        )
        ...
        val project1 = Project(
            name = "유기묘 위치 정보 공유 서비스",
            description = "유기모 위치의 실시간 공유, 임시보호까지 연결해주는 서비스. 구글 맵스를 연동하여 유기묘 위치 정보를...",
            startYear = 2022,
            startMonth = 9,
            endYear = 2022,
            endMonth = 12,
